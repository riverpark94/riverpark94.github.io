...
그렇다면 [TIL 3](https://riverpark94.github.io/devlog/2020/05/07/JS-TIL3/)에서 배운 배열은 어떨까?
...
[1.2 키와 값에 접근하기]에서 키와 값에 접근하기 위해서 `for문`이 아니라, `for... in...문`만 언급하고, 모든 키값을 출력하는 방법뿐이 없다고 소개한 이유도 **<u>객체에는 인덱스, 즉 길이가 존재하지 않기 때문이다.</u>**
